...
Data Quality ....................................... 5
  ...
  Ecosystem Spaceborne Thermal Radiometer Experiment
    on Space Station (ECOSTRESS) ................ 5.11
  Advanced Spaceborne Thermal Emission and Reflection
    Radiometer (ASTER) Global Digital Elevation Model
    (GDEM) Version 3 (v3) and Global Water Bodies
    Database (WBD) Version 1 (v1)................ 5.12
Data Caveats ....................................... 6
Documentation ...................................... 7
...
1. Request Parameters
   ------------------
Request Name:   COGS Project
Date Completed: 2019-11-26T22:09:23.453985
Id:             0f16ee00-324c-4a85-aeb9-9d5d7ecbe6ae

Details:
    Input Vector Name:         CA_State_TIGER2016
    Number of Vector Features: 1
    Start Date:                07-01-2018
    End Date:                  07-01-2019
    Layers:
                               _1_km_16_days_EVI (MOD13A2.006)
                               _1_km_16_days_NDVI (MOD13A2.006)
                               _1_km_16_days_pixel_reliability (MOD13A2.006)
                               FireMask (MOD14A2.006)
                               QA (MOD14A2.006)
...
Version:
    This request was processed by AppEEARS version 2.31.2


2. Request File Information
   ------------------------
Supporting Files:
    COGS-Project-MOD11A2-006-metadata.xml
    COGS-Project-MOD13A2-006-metadata.xml
    COGS-Project-MOD14A2-006-metadata.xml
    COGS-Project-granule-list.txt
    COGS-Project-request.json
    MOD11A2-006-QC-Day-lookup.csv
    MOD11A2-006-QC-Night-lookup.csv
    MOD13A2-006-1-km-16-days-pixel-reliability-lookup.csv
    MOD13A2-006-1-km-16-days-VI-Quality-lookup.csv
    MOD14A2-006-QA-lookup.csv
    MOD11A2-006-QC-Day-Statistics-QA.csv
    MOD11A2-006-QC-Night-Statistics-QA.csv
    MOD13A2-006-1-km-16-days-pixel-reliability-Statistics-QA.csv
    MOD13A2-006-1-km-16-days-VI-Quality-Statistics-QA.csv
    MOD14A2-006-QA-Statistics-QA.csv
    MOD14A2-006-FireMask-Statistics.csv
    MOD11A2-006-Statistics.csv
    MOD13A2-006-Statistics.csv

Data Files:
    Number of Extracted Data Files:     472
    Total Size of Extracted Data Files: 227.29 MB
...
regarding data collections/products and their associated QA data layers.
 ...
 5.01 MODIS (Terra, Aqua, & Combined)
  ...
  https://lpdaac.usgs.gov/resources/e-learning/ for more QA information
 ...
 5.02 NASA MEaSUREs WELD (CONUS & Alaska)
  ...
  https://lpdaac.usgs.gov/product_search/?collections=MEaSUREs+WELD&view=list
 ...
 5.03 NASA MEaSUREs SRTM v3 (30m & 90m)
  ...
  for additional information regarding the SRTM "NUM" file.
 ...
 5.05 S-NPP NASA VIIRS
  ...
  NOTE:
    ...
    https://lpdaac.usgs.gov/documents/123/VNP09_User_Guide_V1.1.pdf
    ...
    https://lpdaac.usgs.gov/documents/124/VNP09_User_Guide_V1.6.pdf
 ...
 5.11 ECOSTRESS
      ---------
  Quality information varies by product for the ECOSTRESS product suite. Quality
  information for ECO2LSTE.001, including the bit definition index for the
  quality layer, is provided in section 2.4 of the User Guide:
  https://lpdaac.usgs.gov/documents/423/ECO2_User_Guide_V1.pdf Results downloaded
  from AppEEARS contain the requested pixel/data values and also the
  decoded QA information associated with each pixel/data value extracted. No quality
  flags are produced for the ECO3ETPTJPL.001, ECO4WUE.001, or ECO4ESIPTJPL.001
  products. Instead, the quality flags of the source data are available in the
  ECO3ANCQA.001 data product and a cloud mask is available in the ECO2CLD.001
  product. The ‘ETinst’ layer in the ECO3ETPTJPL.001 product does include an
  associated uncertainty layer that is provided with each request for ‘ETinst’
  in AppEEARS. ECO2CLD.001 and ECO3ANCQA.001 are separate quality products that
  are also available for download in AppEEARS.

 5.12 ASTER GDEM v3 and Global Water Bodies Database v1
      -------------------------------------------------
  ASTER GDEM v3 data are accompanied by an ancillary "NUM" file in place of the
  QA/QC files. The "NUM" files refer to the count of ASTER Level-1A scenes that
  were processed for each pixel or the source of reference data used to replace
  anomalies. The ASTER Global Water Bodies Database v1 products do not contain
  QA/QC files.
  - See Section 7 of the ASTER GDEM user guide:
  https://lpdaac.usgs.gov/documents/434/ASTGTM_User_Guide_V3.pdf
  for additional information regarding the GDEM "NUM" file.
  - See Section 7 of the ASTER Global Water Bodies Database user guide:
  https://lpdaac.usgs.gov/documents/436/ASTWBD_User_Guide_V1.pdf
  for a comparison with the SRTM Water Body Dataset.
...
6. Data Caveats
 ...
 ECOSTRESS
 ---------
  - ECOSTRESS data products are natively stored in swath format. To fulfill
  AppEEARS requests for ECOSTRESS products, the data are first resampled
  from the native swath format to a georeferenced output. This requires the use
  of the requested ECOSTRESS product files and the corresponding ECO1BGEO:
  https://doi.org/10.5067/ECOSTRESS/ECO1BGEO.001 files. The conversion
  leverages the pyresample package’s: https://pyresample.readthedocs.io/en/stable/
  kd_tree algorithm: https://pyresample.readthedocs.io/en/latest/swath.html#pyresample-kd-tree
  using nearest neighbor resampling. The conversion resamples to a Geographic
  (lat/lon) coordinate reference system (EPSG: 4326), which is defined as the
  ‘native projection’ option for ECOSTRESS products in AppEEARS.
...
9. Data Product Citations
   ----------------------
 Didan, K. (2015). MOD13A2 MODIS/Terra Vegetation Indices 16-Day L3 Global 1km SIN Grid V006. NASA EOSDIS Land Processes DAAC. Accessed 2019-11-26 from https://doi.org/10.5067/MODIS/MOD13A2.006. Accessed November 26, 2019.
 
 Giglio, L., Justice, C. (2015). MOD14A2 MODIS/Terra Thermal Anomalies/Fire 8-Day L3 Global 1km SIN Grid V006. NASA EOSDIS Land Processes DAAC. Accessed 2019-11-26 from https://doi.org/10.5067/MODIS/MOD14A2.006. Accessed November 26, 2019.
 
 Wan, Z., Hook, S., Hulley, G. (2015). MOD11A2 MODIS/Terra Land Surface Temperature/Emissivity 8-Day L3 Global 1km SIN Grid V006. NASA EOSDIS Land Processes DAAC. Accessed 2019-11-26 from https://doi.org/10.5067/MODIS/MOD11A2.006. Accessed November 26, 2019.
 

10. Software Citation
   -----------------
 AppEEARS Team. (2019). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 2.31.2. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed November 26, 2019. https://lpdaacsvc.cr.usgs.gov/appeears
